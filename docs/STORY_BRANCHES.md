# Hikaye Dalları ve 10 Son — v0.2

> **Yapı notu:** Oyun artık Detroit tarzı bölüm yapısına geçti: **[CHAPTERS.md](CHAPTERS.md)**. Bu belgedeki 10 son, o yapıda şöyle kullanılır:
...
> - Son 10 (Kırmızı Düğme), Bölüm 1–2'de, iade garantisi içinde erken sondur (CHAPTERS §2.2).
> - Dal noktaları D3–D7 ve D9, CHAPTERS.md'deki **Bölüm 9 (Teklifler)** ve **Bölüm 10 (Dal bölümü)** olarak oynanır.
> - **v0.2:** Heyet dalı (D9) eklendi; dal sonlarında Tolga'nın dönüşü artık Hikmet'in penceresiyle olur (CHAPTERS Bölüm 13); her dalda bir Fatih sahnesi var.
...
flowchart TD
    ...
    C --> KP
    B --> KP
    B -->|"D9: Lütfi'nin heyeti"| HY["Heyet: Konstantinos'un sarayı"] --> H
    Y --> KP
    ...
    RB["Bölüm 1–2, garanti içinde: kırmızı düğme"] --> E10(("10 · Kırmızı Düğme"))
```

**Okuma kılavuzu:** Köşeli kutular sahnelerdir, yuvarlaklar sonlardır. `D0`–`D9` dal noktalarıdır (Matris 1). Sonlar 6, 7, 8 ve 9, oyuncuyu Fatih'in huzuruna **hiç götürmeden** bitirir: hikayenin yönü tamamen değişir.
...
|-----|--------|-------------|---------|-----|-------------------|
| **D0** | Bölüm 1–2 (iade garantisi içinde) | Telsiz-Kumanda | Kırmızı düğmeye bas (3 sn basılı tut) | Anında garaja dönüş | 10 |
| **D1** | Kızak sonu, Haliç | — | Kıyıya yüz | Ordugâh | 1, 2, 3, 4 (Heyet), 5, 6, 7, 8 |
| | | | Zincire yüz | Bizans | 1, 3, 4, 5, 9 |
| **D2** | Ordugâh | Kadri / Lütfi / Urban / pazar | A / B / C / Y yolu | Huzura geliş biçimi | A: 8 · B: 4 (Heyet) · C: 6 · Y: 7 (garanti) · hepsi: 1, 2, 3, 5 |
...
| **D9** | Yol B, Bölüm 9 | Tercüman Lütfi | Elçilik heyetine katıl | Heyet: surların içi, Konstantinos, mektup → Fatih'e Bizans elçisi olarak | 1, 2, 3, 4, 5 |
| | | | Reddet | Otağ kapısı | 1, 2, 3, 5 |
...
| Dal | Türkçe | English |
|-----|--------|---------|
| **D0** | Hikmet (telsiz): *"İlk 10 dakika koşulsuz iade garantisi var. Ama o kırmızı düğmeye basma... Bastın mı? Neden bastın?!"* | Hikmet (radio): *"Don't press the red button... Did you press it? Why did you press it?!"* |
...
| **D9** | Lütfi: *"Ortak, sultan Bizans'a bir elçi heyeti yolluyor. Tercüman olarak ben gidiyorum, sen de 'Frenk danışman' olarak gel."* | Lütfi: *"Partner, the Sultan is sending an embassy into Byzantium. I go as interpreter. You come as 'Frankish consultant'."* |
...
- **Dal:** D1 (zincir) → D8.
- **Koşullar:** Bizans yolu **ya da Heyet dalı (D9)** · mektup teslim edildi · Paradoks ≥ 40 · kilit soruda 💼 *"Ortak kullanım modeli önerebilirim."*
...
- **Son sahnesi:** Fatih, Hikmet'in **Telsiz-Kumanda**'sını 3 dakikada tamir eder ve Tolga'yı tam doğru zamana gönderir.
...
- **Son sahnesi:** Top ateşlenir. Gülle surlara değil, bir yay çizerek tarafsız Galata'ya, bir Ceneviz tüccarının şarap fıçısına düşer. Diplomatik bir kriz çıkar. Fatih: *"Urban, çırağın hesap bilmiyor."* Tolga: *"Hesap makinesi %1'deydi."* Urban ve Tolga kimin suçlu olduğunu tartışırken Telsiz-Kumanda cızırdar: Hikmet pencereyi açıyordur (CHAPTERS Bölüm 13).
...
- **Yeni sahneler:**
  ...
  4. **Fatih sahnesi:** Gemi Haliç'ten çıkarken Fatih kıyıdan Galata'yı incelemektedir. Tolga'yla göz göze gelirler. Fatih bir şey söylemez, sadece başını hafifçe eğer.
- **Son sahnesi:** Tolga, Venedik'e giden bir kadırgada deniz tutmuş hâlde, mektubu sımsıkı tutar. Kaptan: *"Venedik'e hoş geldin. Üç ay sürer."* Hikmet (telsiz): *"Üç ay mı? Senin garantin çoktan bitti. Dayan, pencereyi açıyorum."* (CHAPTERS Bölüm 13.)
...
- **Son sahnesi (başarı):** Fatih mutfağa gelir, üçüncü tabağı tadar ve bir süre konuşmaz. *"Bunu kim pişirdi?"* Kadri ile Tolga aynı anda cevap verir: *"Ben."* Fatih: *"İkiniz de kalın."* Tolga, *Matbah-ı Âmire'nin Gelecek Müşaviri* unvanını alır ve tam unvanı ezberlemeye çalışırken Telsiz-Kumanda cızırdar (CHAPTERS Bölüm 13).
...
- **Yön değişimi:** Tolga İmparator'a **gitmez**. Bizans arşivinde kalır. Fatih'le tek görüşmesi kısa bir resmî denetim ziyaretidir.
- **Yeni sahneler:**
  ...
  2. **Sır perdesi (≈1 dk):** Nihat tekrar belirir, arşivdeki bir dosyayı görür ve donup kalır. Zaman Bürosu'nun kuruluş belgesi, **Form Z-1**, bu arşivdedir: Nihat'ın odasının duvarında (CHAPTERS Bölüm 3) asılı olanın aslı. Altındaki imza: *"T."* Nihat: *"Büromuzun kurucusu... sizsiniz."* Tolga: *"Ben mi? Ben sigortacıyım."*
  3. **Fatih sahnesi (≈1 dk):** Nihat, Büro'nun ilk formunun "yerel makam onayı" alması gerektiğini söyler ve Tolga'yı resmî denetim ziyareti için kısa bir süreliğine otağa götürür. Fatih formu üç dakikada okur ve imzalar: *"Bürokrasinin en iyisi, kısa olanıdır."* Nihat duygulanır.
- **Son sahnesi:** Tolga, Theodoros ve Nihat ilk Zaman Bürosu toplantısını yapar. Gündem maddesi 1: *"Fesli ziyaretçiler hakkında yönetmelik."* Telsiz-Kumanda toplantının ortasında cızırdar (CHAPTERS Bölüm 13). Nihat tutanağa not düşer: *"Kurucu üye erken ayrıldı."*
...
- **Dal:** D0, sadece Bölüm 1–2'de (iade garantisi, CHAPTERS §2.2).
- **Koşul:** Telsiz-Kumanda'nın kırmızı düğmesini, garanti süresi içinde 3 saniye basılı tutmak. Hikmet: *"İlk 10 dakika koşulsuz iade garantisi var evlât."*
- **Garanti sonrası:** Düğme sadece cızırdar ve son tetiklenmez. Basış Hikmet'e ulaşır: Telsiz Bağı +1 (bir kez).
...
| Garanti sonrası, her yerde (son tetiklenmez) | *"Garanti bitti. Ben bir şey yapacağım, bekle."* | *"Warranty's expired. I'll sort something out. Hang on."* |
...
| **4. İki Hükümdar** | ❌ | ✅ | ❌ | ❌ | ✅ | Bizans ya da Yol B'de Heyet dalı |
...
| **10. Kırmızı Düğme** | ✅ | ✅ | ✅ | ✅ | ✅ | Yol seçilmeden önce, Bölüm 1–2'de |
| **Toplam** | **7** | **7** | **7** | **6** | **6** | Her yolun en az 6 sonu var |
...
| Öncelik | Son | Tetik |
|:-------:|-----|-------|
| 1 | **10. Kırmızı Düğme** | Düğme garanti içinde basılı tutuldu (Bölüm 1–2) |
...
| 4 (alternatif) | 📘 📱 🥜 📦 ☕ | 🗣️ B | D9'u kabul et (Heyet), mektubu aç, 📦 Urban'a ver, kilit soruda 💼 | 20 dk |
...
| 10 | Herhangi | — | Bölüm 1–2'de, garanti içinde kırmızı düğmeyi 3 sn basılı tut | 1–12 dk |
...
| 4 (Heyet) | Konstantinos'un sarayı (Bizans haritasını kullanır) | — | Küçük | M5 |
