...
func _run_shots() -> void:
	...
	level.boat.global_position = Vector3(mid.x + 7, level.water_y, mid.z + 2)
	level.boat.look_at(Vector3(mid.x - 20, level.water_y, mid.z), Vector3.UP)
	player.face(level.boat.global_position + Vector3(0, 0.8, 0))
